...
(function () {
  ...
  const addCatalogPosition = (e) => {
    ...
    $(".position-list-kassa").append('<div class="position" id="position-' + positionID + '" data-price="' + positionInfo['price'] + '"><img src="img/position/' + positionInfo['icon'] + '.svg" class="image-position" alt=""/><div class="position-info"><div class="position-info_title"><h3>' + positionInfo['name'] + '</h3></div><div class="position-info_right"><div class="position-info_count"><button class="button-icon-round background count-round" data-type="remove" data-postition="' + positionID + '"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><use xlink:href="/img/0e61676508755ee206b2b956bbda056f.svg#minus"></use></svg></button><p class="text-count count-round">1</p><button class="button-icon-round background count-round" data-type="add" data-postition="' + positionID + '"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><use xlink:href="/img/0e61676508755ee206b2b956bbda056f.svg#plus"></use></svg></button></div><div class="position-info_price"><p class="price">' + positionInfo['price'] + '</p></div><div class="position-info_delite"><button class="button-icon-round position-delite" data-postition="' + positionID + '"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><use xlink:href="/img/0e61676508755ee206b2b956bbda056f.svg#trash"></use></svg></button></div></div></div></div>');
    positionID++;
  ...
  const addUserPosition = () => {
    ...
    $(".position-list-kassa").append('<div class="position" id="position-' + positionID + '" data-price="100"><img src="img/package.svg" class="image-position" alt=""/><div class="position-info"><div class="position-info_title"><h3>Произвольный товар</h3></div><div class="position-info_right"><div class="position-info_count"><button class="button-icon-round background count-round" data-type="remove" data-postition="' + positionID + '"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><use xlink:href="/img/0e61676508755ee206b2b956bbda056f.svg#minus"></use></svg></button><p class="text-count count-round">1</p><button class="button-icon-round background count-round" data-type="add" data-postition="' + positionID + '"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><use xlink:href="/img/0e61676508755ee206b2b956bbda056f.svg#plus"></use></svg></button></div><div class="position-info_price"><input type="number" data-postition="' + positionID + '" class="price" value="100" placeholder="100"/></div><div class="position-info_delite"><button class="button-icon-round position-delite" data-postition="' + positionID + '"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><use xlink:href="/img/0e61676508755ee206b2b956bbda056f.svg#trash"></use></svg></button></div></div></div></div>');
    positionID++;
    editPriceEnd(100);
    countEnd++;
    $("#count-position").text(countEnd === 0 ? "Нет" : countEnd);
